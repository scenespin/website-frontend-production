        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          <HelpSectionCard
            ...
            features={[
              ...
              "GitHub-backed screenplay saving and version history"
            ]}
          />
          <HelpSectionCard
            ...
            features={[
              ...
              "Wryda Provenance Ledger: optional noneditable provenance bundles (PDF + JSON + SHA-256 hash) for WGA/studio workflows",
