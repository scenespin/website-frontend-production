    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-8 py-16">
        ...
        <section className="mb-16">
          ...
          {/* Video Enhancement */}
          <div className="mb-12">
            <h3 className="text-2xl font-bold mb-4">10. Video Enhancement (5 workflows)</h3>
            <p className="text-sm opacity-70 mb-4">Transform existing video footage with special effects, style changes, object removal, and more</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <WorkflowCard
                title="VFX Magic"
