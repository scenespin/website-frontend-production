          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#141414] border border-[#3F3F46] rounded-lg p-6 md:col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-sm">
                <div className="rounded-lg border border-[#2F2F2F] bg-[#0E0E0E] px-3 py-2 text-gray-300 whitespace-nowrap">1) AI action accepted</div>
                <div className="rounded-lg border border-[#2F2F2F] bg-[#0E0E0E] px-3 py-2 text-gray-300 whitespace-nowrap">2) Event recorded</div>
                <div className="rounded-lg border border-[#2F2F2F] bg-[#0E0E0E] px-3 py-2 text-gray-300 whitespace-nowrap">3) Bundle exported</div>
                <div className="rounded-lg border border-[#2F2F2F] bg-[#0E0E0E] px-3 py-2 text-gray-300 whitespace-nowrap">4) Submission ready</div>
              </div>
