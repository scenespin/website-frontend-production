      ...
      <>
        ...
        <section>
          ...
          <ul className={styles.ul}>
            ...
            <li className={styles.li}><strong>All Aspect Ratios</strong> - 16:9, 9:16, 1:1, 4:3</li>
            <li className={styles.li}><strong>Match Style From Existing Footage</strong> - Analyze and match visual styles</li>
