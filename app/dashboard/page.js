              ...
              <div className="flex flex-wrap items-center gap-2 md:gap-4">
                {entityCounts.characters > 0 && (
                  <div className="flex flex-col px-4 py-2 bg-base-200 rounded-lg border border-base-300/50 min-h-[40px] flex-1 min-w-[100px] md:flex-initial">
                    ...
                    <span className="text-xs text-base-content/60 leading-tight text-center mt-0.5">characters</span>
                  </div>
                )}
                {entityCounts.locations > 0 && (
                  <div className="flex flex-col px-4 py-2 bg-base-200 rounded-lg border border-base-300/50 min-h-[40px] flex-1 min-w-[100px] md:flex-initial">
                    ...
                    <span className="text-xs text-base-content/60 leading-tight text-center mt-0.5">locations</span>
                  </div>
                )}
                {entityCounts.assets > 0 && (
                  <div className="flex flex-col px-4 py-2 bg-base-200 rounded-lg border border-base-300/50 min-h-[40px] flex-1 min-w-[100px] md:flex-initial">
                    ...
                    <span className="text-xs text-base-content/60 leading-tight text-center mt-0.5">props</span>
                  </div>
                )}
