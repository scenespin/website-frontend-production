      ...
      <div className="p-4 md:p-5 border-b border-[#3F3F46] flex-shrink-0">
        ...
        {!showAnalyzer && (
          <button
            ...
            className="mt-4 w-full md:w-auto px-4 py-2 bg-[#DC143C] hover:bg-[#B91238] text-white rounded-lg transition-colors flex items-center justify-center gap-2 font-medium text-sm"
          >
            Analyze New Video
          </button>
        )}
