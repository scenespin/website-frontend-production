    ...
    angleVariations.forEach((variation: any) => {
      ...
      const getImageUrl = () => {
        if (viewMode === 'original') {
          ...
          // For older images without metadata, variation.imageUrl might be the original square
          // Check if metadata indicates this was cropped - if not, variation.imageUrl might be original
