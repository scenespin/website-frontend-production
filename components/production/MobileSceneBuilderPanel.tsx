  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900">
      ...
      <div className="px-4 py-3 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
        <h2 className="text-lg font-bold text-slate-900 dark:text-base-content flex items-center gap-2">
        ...
        <div className="border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-900 dark:text-base-content">
                Story Beats
              </span>
              {selectedBeatId && (
        ...
        <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 shadow-lg">
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 py-3 px-4 rounded-lg bg-primary text-base-content font-semibold
