        ...
        <div className="max-w-7xl mx-auto w-full px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-gradient-to-r from-cinema-red to-cinema-blue rounded-lg flex items-center justify-center">
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
                    isActive(item.href)
                      ? 'bg-gradient-to-r from-cinema-red to-cinema-blue text-white'
            ...
            <div className="flex items-center gap-4">
              {user && (
                <Link href="/pricing" className="btn btn-sm gap-2">
