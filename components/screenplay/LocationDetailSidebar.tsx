              ...
              <div className="space-y-3">
                ...
                <div>
                  <button
                    ...
                    className="w-full px-4 py-2.5 rounded-lg text-sm font-medium transition-all hover:bg-[#1F1F1F] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5"
                    style={{ 
