                    ...
                    <div className="bg-[#0A0A0A] border border-[#3F3F46] rounded-2xl p-6 max-w-md mx-4 shadow-xl w-full">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="w-full h-12 px-4 bg-[#141414] border border-[#3F3F46] rounded-lg text-base text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#DC143C]/40 focus:border-[#DC143C]"
                                autoFocus
                                onKeyDown={(e) => {
                        ...
                        <div className="bg-[#141414] border border-[#3F3F46] rounded-lg p-3 mb-4 text-sm text-gray-300">
                            <p className="flex items-start gap-2">
                                <svg className="w-4 h-4 mt-0.5 text-[#DC143C] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={handleSave}
                                disabled={saving}
                                className="btn flex-1 gap-2 bg-[#DC143C] hover:bg-[#DC143C]/80 text-white border-none"
                            >
                                {saving ? (
                                    <>
                    ...
                    <div className="bg-[#0A0A0A] border border-[#3F3F46] rounded-2xl p-6 max-w-md mx-4 shadow-xl w-full">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="btn flex-1 bg-[#DC143C] hover:bg-[#DC143C]/80 text-white border-none"
                            >
                                Connect GitHub
                            </button>
                            <button
    ...
    return (
        <div className={`bg-[#0A0A0A] border-t border-white/10 shadow-sm ${className}`}>
            ...
            <div className="hidden md:flex flex-wrap items-center gap-2 p-2">
                ...
                {/* Export button - PDF/FDX modal */}
                {onExportPDF && (
                    <div className="tooltip tooltip-bottom" data-tip="Export screenplay • PDF or FDX • Cmd+P">
                        <button
                            onClick={onExportPDF}
                            className="px-2 py-2 bg-base-300 hover:bg-[#DC143C]/10 hover:text-[#DC143C] rounded text-xs font-semibold min-w-[40px] min-h-[40px] flex flex-col items-center justify-center transition-colors"
                        >
            ...
            <div className="md:hidden flex flex-col gap-1.5 p-1.5">
                ...
                <div className="grid grid-cols-8 gap-1">
                    ...
                    {/* Export (PDF/FDX) */}
                    {onExportPDF && (
                        <div className="tooltip tooltip-bottom" data-tip="Export screenplay • PDF or FDX">
                            <button
                                onClick={onExportPDF}
                                className="w-full px-1 py-1.5 bg-base-300 hover:bg-[#DC143C]/10 hover:text-[#DC143C] rounded text-xs font-semibold min-h-[36px] flex flex-col items-center justify-center transition-colors"
                            >
                                <span className="text-sm">⬇️</span>
                                <span className="text-[8px] leading-tight">Export</span>
                            </button>
                        </div>
                    )}
