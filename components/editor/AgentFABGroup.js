 ...
 * 
 * Three stacked FABs: Rewrite (bottom), Screenwriter (middle), Wryda Tab (top)
 * Director and Dialogue agents moved to toolbar
 * Mobile: Positioned bottom-right, 48px buttons
 * Desktop: Positioned bottom-right, 40px buttons
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.button
          ...
          transition={{ 
            scale: { delay: hasSelection ? 0.2 : 0.3, type: 'spring', stiffness: 260, damping: 20 },
            opacity: { delay: hasSelection ? 0.2 : 0.3 },
        ...
        {onWrydaTabClick && (
          <motion.button
            ...
            style={{
              ...
              background: 'linear-gradient(135deg, rgba(220, 20, 60, 0.75) 0%, rgba(139, 0, 0, 0.75) 100%)',
              opacity: 0.9
            }}
            initial={{ scale: 0, opacity: 0 }}
