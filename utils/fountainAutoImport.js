...
import { detectElementType } from './fountain';

/**
 * Parse Fountain content and extract all locations and characters
 * @param {string} content - Fountain screenplay text
 * @returns {{locations: Set<string>, characters: Set<string>, scenes: Array}} Object containing unique locations, characters, and scene breakdown
 */
export function parseContentForImport(content) {
 ...
 * @returns {boolean} True if content appears to be a screenplay
 */
export function shouldAutoImport(content) {
 ...
 * @param {string} character - Raw character string
