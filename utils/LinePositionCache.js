...
export class LinePositionCache {
     ...
     * @returns {number} Character position at the start of that line
     */
    getCharPosition(content, lineNumber) {
     ...
     * 
     * @param {string} content - The full text content
     * @returns {number[]} Array of character positions, indexed by line number (0-based)
     */
