...
export const llmModels = [
  ...
  // xAI
  { id: 'grok-4.20-0309-reasoning', name: 'Grok 4.20 Reasoning', provider: 'xAI', description: 'Advanced reasoning model with 2M context. Best for deep analysis and planning.' },
  { id: 'grok-4.20-0309-non-reasoning', name: 'Grok 4.20', provider: 'xAI', description: 'General-purpose non-reasoning Grok 4.20 with 2M context for broad writing tasks.' },
  { id: 'grok-4.20-multi-agent-0309', name: 'Grok 4.20 Multi-Agent', provider: 'xAI', description: 'Grok 4.20 tuned for complex multi-agent style workflows and coordination.' },
...
export const videoModels = [
  { id: 'ltx-2.3-fast', name: 'LTX 2.3 Fast', provider: 'Lightricks', description: 'Fast text/image-to-video generation with synchronized audio support.' },
  { id: 'ltx-2.3-pro', name: 'LTX 2.3 Pro', provider: 'Lightricks', description: 'Higher-fidelity LTX generation with stronger temporal stability and audio sync.' },
