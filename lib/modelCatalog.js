...
export const llmModels = [
  ...
  // OpenAI
  { id: 'gpt-5.4', name: 'GPT-5.4', provider: 'OpenAI', description: 'Frontier reasoning model for complex professional work with stronger precision on hard writing and planning tasks.' },
...
export const imageModels = [
  ...
  { id: 'grok-imagine-image', name: 'Grok Imagine (Standard)', provider: 'xAI', description: 'Fast text-to-image and editing model. Supports up to 5 input images for edits, 2K output, and higher throughput (300 RPM).' },
...
export const videoModels = [
  ...
  { id: 'luma-ray-2', name: 'Luma Ray 2', provider: 'Luma', description: 'Photorealistic video from text. 5 or 9 second clips, keyframes, camera controls, and 4K output support.' },
  ...
  { id: 'grok-imagine-video', name: 'xAI Grok Video', provider: 'xAI', description: 'Text and image to video. Editing, restyling, motion control. Supports 5, 10, and 15 second outputs.' },
];
