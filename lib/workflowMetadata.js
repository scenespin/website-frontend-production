...
export const WORKFLOW_METADATA = {
  ...
  'product-reshoot': {
    ...
    experienceLevel: 'beginner',
    outputType: 'single',
    heroDescription: 'Transform product photos or videos with new backgrounds, lighting, or settings. No expensive photoshoots required.',
    whatItDoes: 'Upload your product image or video and describe the desired presentation. The AI maintains your product exactly while transforming the background, environment, and lighting. Perfect for e-commerce sellers, real estate agents, and marketers who need professional product presentations without the cost of traditional photography.',
    perfectFor: [
      'E-commerce sellers needing multiple product backgrounds',
      'Virtual staging for real estate listings',
      'Product demos in different lifestyle contexts',
      'Marketing materials without additional photoshoots',
      'Seasonal or themed product presentations',
    ],
    proTip: 'Shoot your product once with good lighting, then create unlimited variations. Much cheaper than traditional product photography and you can test different presentations instantly.',
    creditRange: { min: 75, max: 100 },
  ...
  'still-photo-performer': {
    ...
    experienceLevel: 'advanced',
    outputType: 'single',
    heroDescription: 'Animate still photos with your voice and expressions. Make grandma\'s photo speak again. Viral content potential.',
    whatItDoes: 'Upload any portrait photo and record yourself speaking or performing. The AI transfers your facial expressions, movements, and voice to the photo, bringing it to life. Revolutionary for creating emotional tribute videos, animating historical figures, or making family memories interactive. This workflow has massive viral potential for its emotional impact.',
    perfectFor: [
      'Memorial and tribute videos (animate photos of deceased loved ones)',
      'Educational content (bring historical figures to life)',
      'Family memories (make old photos speak and move)',
      'Virtual spokespersons from illustrations or artwork',
      'Avatar animation for content creation',
    ],
    proTip: 'Film yourself with good lighting and exaggerate your expressions slightly. The photo will adopt YOUR movements, speech, and emotions. Perfect for creating deeply personal, shareable content.',
    creditRange: { min: 125, max: 150 },
