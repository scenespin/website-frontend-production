...
export const WORKFLOW_METADATA = {
  ...
  'genre-camera-variants': {
    ...
    experienceLevel: 'advanced',
    outputType: 'multiple',
    heroDescription: 'Same scene → 5 different GENRES! Horror, action, drama, comedy, documentary cinematography.',
    whatItDoes: 'YOU: Describe scene → AI: Shoots it 5 WAYS! Horror uses unsettling angles, action has dynamic movement, drama features intimate push-ins. Learn how camera work affects emotion!',
    technicalDetails: 'Genre-specific cinematography application with matching camera language: horror (Dutch angles, unstable framing), action (dynamic movement, quick cuts), drama (intimate framing, slow pushes), comedy (bright even lighting, medium shots), documentary (observational style, natural movement). Educational workflow for cinematography principles.',
    perfectFor: [
      'Match cinematography to your genre',
      'Film school & cinematography education',
      'Client presentations showing tonal options',
      'Learn how technique affects emotion',
      'Find perfect camera style for story',
    ],
    proTip: '🎓 EDUCATIONAL GOLD! See how much camera work affects mood. Horror feels scary because of HOW it\'s shot!',
    creditRange: { min: 250, max: 350 },
    tags: ['needs-images', 'multi-output', 'character-consistency-required', 'client-work', 'generation'],
    stars: 5,
    categoryOrder: 7,
  ...
  'shot-type-variants': {
    ...
    experienceLevel: 'advanced',
    outputType: 'multiple',
    heroDescription: 'COMPLETE COVERAGE from one generation! Wide, medium, close-up, OTS, POV, insert shots.',
    whatItDoes: 'YOU: Describe scene → AI: Shoots it 7 WAYS! Establishing wide, medium shot, close-up, over-shoulder, POV, insert, reaction. Like having a full camera crew!',
    technicalDetails: 'Multi-coverage generation delivering standard production shot types: establishing wide (scene context), medium (character framing), close-up (emotion detail), over-the-shoulder (conversation), POV (character perspective), insert (detail shots), reaction (cutaway). Provides editorial flexibility in post-production.',
    perfectFor: [
      'Professional productions needing editorial flexibility',
      'Dynamically edited sequences',
      'Shot library building',
      'Simulate multi-camera shoots',
      'Options for pacing adjustments',
    ],
    proTip: '🎬 Essential for EDITING! Different shot types = pacing control. Cut to close-up for emotion, wide for context!',
    creditRange: { min: 250, max: 350 },
    tags: ['needs-images', 'multi-output', 'character-consistency-required', 'client-work', 'generation'],
    stars: 5,
    categoryOrder: 7,
  ...
  'b-roll-master': {
    ...
    experienceLevel: 'intermediate',
    outputType: 'multiple',
    heroDescription: 'Professional B-roll package! Establishing shots, cutaways, detail shots - everything you need.',
    whatItDoes: 'YOU: Describe main scene → AI: Generates COMPLETE B-roll package! Establishing shots, cutaways, environmental details, atmospheric footage. What separates amateur from PRO!',
    technicalDetails: 'Automated B-roll generation suite creates supplemental footage package: establishing shots (location context), cutaway shots (visual variety), environmental details (atmosphere building), insert shots (detail focus). Professional production workflow reduces shoot time and cost.',
    perfectFor: [
      'Documentary & narrative projects',
      'YouTube videos needing visual variety',
      'Corporate videos with production polish',
      'Tutorial content with insert shots',
      'Anything needing cutaway footage',
    ],
    proTip: '📹 B-roll = PROFESSIONAL difference! Cuts boring talking heads. Keeps viewers engaged with visual variety!',
    creditRange: { min: 200, max: 300 },
    tags: ['needs-images', 'multi-output', 'character-consistency-required', 'client-work', 'generation'],
    stars: 5,
    categoryOrder: 7,
  ...
  'coverage-master': {
    ...
    experienceLevel: 'advanced',
    outputType: 'multiple',
    heroDescription: 'TV/FILM-STANDARD coverage! Master shot, over-shoulder, close-ups, reactions - complete dialogue coverage.',
    whatItDoes: 'YOU: Describe dialogue scene → AI: Shoots like Hollywood! Master shot + OTS angles + close-ups + reactions. Edit like a professional film!',
    technicalDetails: 'Professional dialogue coverage workflow: master shot (wide establishing), over-the-shoulder angles (conversation framing), individual close-ups (emotional detail), reaction shots (cut-aways). Standard TV/film production coverage for dialogue scenes. Enables professional shot-reverse-shot editing patterns.',
    perfectFor: [
      'Dialogue scenes & conversations',
      'Interview-style content',
      'Dramatic scenes requiring emotional coverage',
      'Professional narrative projects',
      'Content requiring broadcast standards',
    ],
    proTip: '🎥 Study how pro films cut dialogue! This gives you ALL those shots automatically. Master → OTS → Close-up = classic!',
    creditRange: { min: 300, max: 400 },
    tags: ['needs-images', 'multi-output', 'quality-premium', 'character-consistency-required', 'client-work', 'generation'],
    stars: 5,
    categoryOrder: 7,
  ...
  'scene-variants': {
    ...
    experienceLevel: 'intermediate',
    outputType: 'multiple',
    heroDescription: 'Same scene → Different MOODS! Golden hour, overcast, night, midday. Find perfect atmosphere!',
    whatItDoes: 'YOU: Describe scene → AI: Generates MULTIPLE atmospheres! Golden hour sunlight, moody overcast, dramatic night, bright midday. Pick your vibe!',
    technicalDetails: 'Atmospheric variation generation with lighting and weather conditions: golden hour (warm directional light), overcast (diffused soft light), night (dramatic low-key lighting), midday (bright high-key). Time-of-day storytelling and mood exploration workflow.',
    perfectFor: [
      'Client presentations with options',
      'Find perfect mood for scene',
      'Atmospheric exploration',
      'Time-of-day storytelling',
      'Weather & lighting tests',
    ],
    proTip: '🌅 Lighting = EMOTION! Same scene feels hopeful at sunrise, ominous at night. Test atmospheres to find your story\'s mood!',
    creditRange: { min: 250, max: 350 },
    tags: ['needs-images', 'multi-output', 'character-consistency-required', 'generation'],
    stars: 4,
    categoryOrder: 7,
