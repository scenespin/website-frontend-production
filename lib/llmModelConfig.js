...
export const LLM_MODELS = [
  ...
  { id: 'gpt-4o', name: 'GPT-4o', shortName: 'GPT-4o', tier: 'Balanced', badges: '⚡ ✍️' },
  // Reasoning (quality / hard prompts)
  { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', shortName: 'Gemini 2.5 Pro', tier: 'Reasoning', badges: '🧠 ✍️' },
  { id: 'gemini-3-pro-preview', name: 'Gemini 3 Pro', shortName: 'Gemini 3 Pro', tier: 'Reasoning', badges: '🧠' },
  { id: 'gpt-5.4', name: 'GPT-5.4', shortName: 'GPT-5.4', tier: 'Reasoning', badges: '🧠 ✍️' },
  { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', shortName: 'Sonnet 4.6', tier: 'Reasoning', badges: '🧠 ✍️' },
  { id: 'grok-4.20-0309-reasoning', name: 'Grok 4.20', shortName: 'Grok 4.20', tier: 'Reasoning', badges: '🧠' },
