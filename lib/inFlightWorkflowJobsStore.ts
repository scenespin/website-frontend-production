 ...
 *
 * Tracks workflow-execution job IDs that are running so we can poll for completion
 * even when the Jobs drawer is closed. Scene Builder registers jobs here when they
 * start; WorkflowCompletionPoller polls until done and refreshes media.
 */
